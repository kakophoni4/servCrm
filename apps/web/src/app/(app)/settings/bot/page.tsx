    ...
    <div>
        ...
        {config ? (
          <>
            ...
            <p className="muted" style={{ marginBottom: 0 }}>
              ...
              {config.baseUrl ? ` · BASE_URL=${config.baseUrl}` : ' · BASE_URL не задан'}
            </p>
          </>
        ) : (
      ...
      <form className="panel" onSubmit={save} style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <button className="btn secondary" type="button" onClick={runSetWebhook}>
            Установить webhook
          </button>
        </div>
        ...
        {webhook?.ok ? (
          <p style={{ marginTop: 12, color: '#0f766e', wordBreak: 'break-all' }}>
